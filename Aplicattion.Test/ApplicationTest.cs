...
namespace Aplicattion.Test
{
    public class Tests
    {
        ...
        public void EnviarSolicitudLibro()
        {
            ...
            SendRequestService _sendRequestService = new SendRequestService(new UnitOfWork(_context));
            var propertiesRequest = new SendRequestProperties { TitleProductivity = "DDD" };
            var responseRequest = _sendRequestService.SendProductivity(propertiesRequest);
        ...
        public void EnviarSolicitudEvent()
        {
            ...
            SendRequestService _sendRequestService = new SendRequestService(new UnitOfWork(_context));
            var propertiesRequest = new SendRequestProperties { TitleProductivity = "Ready Player One" };
            var responseRequest = _sendRequestService.SendProductivity(propertiesRequest);
        ...
        public void EnviarSolicitudSoftware()
        {
            ...
            SendRequestService _sendRequestService = new SendRequestService(new UnitOfWork(_context));
           var propertiesRequest = new SendRequestProperties { TitleProductivity = "Ciarp" };
           var responseRequest = _sendRequestService.SendProductivity(propertiesRequest);
